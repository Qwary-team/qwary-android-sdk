  ...
  if (!window.qwTracking) {
    ...
    var t = function (t) {
      ...
      (e.type = "text/javascript"),
        (e.async = !0),
        (e.src =
          "https://static.qwary.com/resources/sdk/mobile_intercept/qw.intercept.sdk.js?id=" +
          app_id);
  ...
  window.qwSettings = {
      ...
      if (!window.qwTracking) {
          ...
          var t = function (t) {
              ...
              e.type = "text/javascript", e.async = !0, e.src = "https://static.qwary.com/resources/sdk/mobile_intercept/qw.intercept.sdk.js?id=" + app_id;
              var n = document.getElementsByTagName("script")[0];
              // Satinder Change as n is undefined  n.parentNode.insertBefore(e,n)
              document.head.appendChild(e);
          };
